...
Uses [spex](https://github.com/github/spec-kit) for spec-driven development. Project constitution and memory in `.specify/memory/`. Specs managed via `speckit.*` slash commands.

## Development Guidelines
- Think in English, generate responses in Simplified Chinese. All Markdown content written to project files MUST be in Simplified Chinese.
