  ...
  ({ className, size = 'default', unstyled = false, ...props }, ref) => {
    return (
      ...
      >
        <textarea
          className={cn(
            'field-sizing-content min-h-17.5 w-full rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-none placeholder:text-muted-foreground/72 max-sm:min-h-20.5',
            size === 'sm' &&
