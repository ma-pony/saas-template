...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Licenses',
  description: 'License information for [Your Company] platform',
})
      ...
      <main className='min-h-screen pt-14'>
        <div className='mx-auto max-w-4xl px-4 py-16 sm:px-6'>
          ...
          <div className='prose prose-sm max-w-none space-y-8 text-muted-foreground'>
            <section>
              <h2 className='mb-4 text-xl font-semibold text-foreground'>1. codebase</h2>
              <p>
                the boilerplate and related source code are licensed for commercial and personal
                projects with a valid purchase or access key. redistribution or resale without
            ...
            <section>
              ...
              <p>
                this project includes open-source libraries under their respective licenses (MIT,
