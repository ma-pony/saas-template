        ...
        <div className='mx-auto max-w-7xl flex h-14 items-center justify-between gap-8 px-4 sm:px-6'>
          ...
          <div className='flex items-center gap-6'>
            <div className='hidden items-center gap-6 md:flex'>
              <Link href='/#features' className='text-sm font-medium text-muted-foreground transition-colors duration-200 ease-in-out hover:text-foreground'>
                {t('features')}
              </Link>
              <Link href='/#pricing' className='text-sm font-medium text-muted-foreground transition-colors duration-200 ease-in-out hover:text-foreground'>
                {t('pricing')}
              </Link>
              <Link href='/#wall-of-love' className='text-sm font-medium text-muted-foreground transition-colors duration-200 ease-in-out hover:text-foreground'>
                {t('wallOfLove')}
              </Link>
            ...
            <a
              ...
              aria-label='GitHub'
            >
              <svg viewBox='0 0 16 16' className='h-5 w-5 text-[#38383A]' fill='currentColor' aria-hidden='true'>
        ...
        {isMenuOpen && (
          <div className='border-t border-border md:hidden'>
            <div className='mx-auto max-w-6xl space-y-1 px-4 sm:px-6 pb-3 pt-2'>
              <Link href='#features' className='block rounded-md px-3 py-2 text-sm font-medium text-muted-foreground transition-all duration-200 ease-in-out hover:bg-accent hover:text-accent-foreground' onClick={toggleMenu}>
                {t('features')}
              </Link>
              <Link href='#pricing' className='block rounded-md px-3 py-2 text-sm font-medium text-muted-foreground transition-all duration-200 ease-in-out hover:bg-accent hover:text-accent-foreground' onClick={toggleMenu}>
                {t('pricing')}
              </Link>
              <Link href='#wall-of-love' className='block rounded-md px-3 py-2 text-sm font-medium text-muted-foreground transition-all duration-200 ease-in-out hover:bg-accent hover:text-accent-foreground' onClick={toggleMenu}>
                {t('wallOfLove')}
              </Link>
